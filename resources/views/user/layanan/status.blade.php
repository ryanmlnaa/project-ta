        ...
        <div class="table-responsive">
            <table class="spp-table">
                ...
                <tbody>
                    ...
                    <tr class="spp-row">
                        <td>
                            <span class="spp-number">{{ $loop->iteration }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            @if($item->status == 'diajukan')
                                <span class="spp-badge spp-badge--blue">
                                    <span class="spp-badge-dot"></span> Diajukan
                                </span>
                            @elseif($item->status == 'diproses')
                                <span class="spp-badge spp-badge--amber">
                                    <span class="spp-badge-dot spp-badge-dot--pulse"></span> Diproses
                                </span>
                            @else
                                <span class="spp-badge spp-badge--green">
                                    <span class="spp-badge-dot"></span> Selesai
                                </span>
                            @endif
                        </td>
                        <td>
                            <button class="spp-btn-detail"
                                data-toggle="modal"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content spp-modal">
            ...
            <div class="spp-modal-header">
                ...
                <button class="spp-modal-close" data-dismiss="modal">
            ...
            <div class="spp-modal-body">
                ...
                {{-- Tanggapan --}}
                <div class="spp-modal-section">
                    <span class="spp-modal-label"><i class="fas fa-reply me-1"></i> Tanggapan Admin</span>
                    <div class="spp-modal-box {{ !$item->tanggapan_admin ? 'spp-modal-box--empty' : '' }}">
                        @if($item->tanggapan_admin)
                            {{ $item->tanggapan_admin }}
                        @else
                            <span class="spp-empty-reply"><i class="far fa-clock me-1"></i> Menunggu tanggapan admin...</span>
                        @endif
                    </div>
                </div>
                ...
                @if($item->foto)
                <div class="spp-modal-section">
                    <span class="spp-modal-label"><i class="fas fa-image me-1"></i> Foto Lampiran</span>
...
.spp-header-bg {
    ...
    inset: 0;
    background-image:
        radial-gradient(circle at 85% 20%, rgba(255,255,255,0.07) 0%, transparent 50%),
...
.spp-btn-detail:active { transform: translateY(0); }
