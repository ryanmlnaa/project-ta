            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    ...
                    href="{{ route('user.iuran') }}">
                        <i class="fas fa-wallet"></i> Lihat Data Iuran
                    </a>
                </li>

                {{-- 🔥 UPLOAD PEMBAYARAN --}}
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('user.upload.pembayaran') ? 'active text-primary fw-bold' : '' }}"
                ...
                {{-- 🔥 STATUS PEMBAYARAN --}}
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('user.status.pembayaran') ? 'active text-primary fw-bold' : '' }}"
                ...
                {{-- 🔥 STATUS PENGADUAN --}}
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('user.status.pengaduan') ? 'active text-primary fw-bold' : '' }}"
                    href="{{ route('user.status.pengaduan') }}">
