            ...
            <div class="card-body">
                                    ...
                                    <td>
                                        ...
                                        @if(auth()->user()->role == 'rt' && $item->status == 'diajukan')
                                            <form action="{{ route('layanan.tanggapi.rt', $item->id) }}" method="POST">
                                                ...
                                                <button class="btn btn-primary btn-sm">Tanggapi RT</button>
                                            </form>
                                        @endif
                                        ...
                                        @if(auth()->user()->role == 'admin' && $item->status == 'proses')
                                            <form action="{{ route('layanan.approve.admin', $item->id) }}" method="POST">
                                                @csrf
                ...
                <div class="modal fade" id="modalTanggapi">
                    <div class="modal-dialog">
                        <form id="formTanggapi" method="POST" action="#">
                            @csrf
                            @method('PUT')
...
<script>
    function setForm(id) {
        ...
        form.action = "{{ route('layanan.tanggapi', ':id') }}".replace(':id', id);
    }
</script>
