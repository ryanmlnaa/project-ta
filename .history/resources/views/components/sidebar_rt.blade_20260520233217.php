...
<ul class="sidebar-admin-ul" id="sidebarMain">
    ...
    <li class="sa-item {{ request()->routeIs('rt.rumah') ? 'active' : '' }}">
        <a class="sa-link" href="{{ route('rt.rumah') }}">
            <i class="fas fa-building"></i><span>Data Rumah</span>
        </a>
    </li>

    <li class="sa-item {{ request()->routeIs('rt.iuran') ? 'active' : '' }}">
        <a class="sa-link" href="{{ route('rt.iuran') }}">
            <i class="fas fa-wallet"></i><span>Data Iuran</span>
        </a>
    </li>

    <li class="sa-item {{ request()->routeIs('rt.layanan') ? 'active' : '' }}">
            <a class="sa-link" href="{{ route('rt.layanan') }}">
            <i class="fas fa-comments"></i><span>Layanan Pengaduan</span>
        </a>
    </li>
    ...
    <li class="sa-item {{ request()->routeIs('rt.informasi') ? 'active' : '' }}">
        <a class="sa-link" href="{{ route('rt.informasi') }}">
            <i class="fas fa-bullhorn"></i><span>Informasi</span>
        </a>
    </li>

    <li class="sa-item {{ request()->routeIs('rt.laporan') ? 'active' : '' }}">
        <a class="sa-link" href="{{ route('rt.laporan.index') }}">
