...
/* ── TABLE WRAPPER — KUNCI SCROLL HORIZONTAL ── */
.table-wrapper {
    width: 100%;
    overflow-x: auto;
...
/* Paksa tabel penghuni cukup lebar agar semua kolom terlihat */
#tablePenghuni {
    min-width: 1100px;
}
...
/* ── DataTable: bungkus agar scroll tidak konflik ── */
.dataTables_wrapper {
    padding: 0;
    min-width: 0;
}
...
/* DataTable scroll body — biar kolom tidak terpotong */
...
<div class="container-fluid">
    ...
    <div class="premium-card">
        ...
        {{-- padding:0 agar DataTable menempel ke card --}}
        <div class="premium-card-body" style="padding: 0;">
            {{-- table-wrapper membungkus DataTable agar bisa scroll horizontal --}}
...
$(document).ready(function () {
    if ($.fn.DataTable) {
        ...
        $('#tablePenghuni').DataTable({
            ...
            // scrollX memaksa DataTable membuat scroll horizontal sendiri
            scrollX: true,
