...
document.querySelectorAll('.btn-detail').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        document.getElementById('d_blok').innerText = this.dataset.blok;
        document.getElementById('d_nomor').innerText = this.dataset.nomor;
        document.getElementById('d_status').innerText = this.dataset.status;

        document.getElementById('d_nama').innerText = this.dataset.nama;
        document.getElementById('d_email').innerText = this.dataset.email;
        document.getElementById('d_telepon').innerText = this.dataset.telepon;
