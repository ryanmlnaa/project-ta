...
$(document).ready(function () {
    ...
    // 🔥 DataTables (sekali saja)
    if (!$.fn.DataTable.isDataTable('#tablePenghuni')) {
        $('#tablePenghuni').DataTable();
    }

    if (!$.fn.DataTable.isDataTable('#tableRumah')) {
    ...
    // 🔥 FIX PALING KUAT (ANTI GAGAL TOTAL)
...
@section('scripts')
<script>
function showDetail(blok, nomor, status, nama, email, telepon) {

    console.log("CLICK WORK"); // debug

    document.getElementById('d_blok').innerText = blok;
    ...
    document.getElementById('d_telepon').innerText = telepon;
