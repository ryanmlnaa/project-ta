                            ...
                            @forelse($rumahList as $r)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-info btn-sm btn-detail" data-blok="{{ $r->blok }}"
        ...
        <div class="modal-content">
            <form action="{{ route('rumah.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="no_rumah" id="no_rumah" class="form-control mb-2" placeholder="No Rumah"
                        required>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            // CEK dulu sebelum pakai DataTable
            if ($.fn.DataTable) {
