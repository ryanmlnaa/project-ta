...
#tablePenghuni { min-width: 1080px; }
#tableRumah    { min-width: 780px; }
                    ...
                    <tbody>
                        @forelse($penghuni as $p)
                            <tr>
                                ...
                                <td>{{ $p->alamat }}</td>
                                <td class="nowrap">{{ $p->rumah->blok ?? '-' }}</td>
                                <td class="nowrap">{{ $p->rumah->no_rumah ?? '-' }}</td>
                                <td class="nowrap">
                    ...
                    <div style="display:grid; gap:12px;">
                        <div>
                            ...
                            <select name="blok" id="blok_input" class="form-control" required
                                ...
                                <option value="A">Cluster Gardenia Blok A (1–24)</option>
                                <option value="B">Cluster Gardenia Blok B (1–20)</option>
                                <option value="C">Cluster Gardenia Blok C (1–24)</option>
                                <option value="D">Cluster Gardenia Blok D (1–20)</option>
                                <option value="E">Cluster Gardenia Blok E (1–20)</option>
                                <option value="F">Cluster Gardenia Blok F (1–21)</option>
                                <option value="G">Cluster Gardenia Blok G (1–32)</option>
                                <option value="H">Cluster Edelweis Blok H (1–37)</option>
                                <option value="I">Cluster Edelweis Blok I (1–31)</option>
                                <option value="J">Blok J (1–17)</option>
                                <option value="K">Blok K (1–16)</option>
                                <option value="L">Blok L (1–10)</option>
                            </select>
                        </div>
                        <div>
