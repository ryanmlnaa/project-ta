...
<div style="display:flex; align-items:center; gap:12px; margin-bottom:20px; flex-wrap:wrap;">
    ...
    <div style="display:flex; align-items:center; gap:8px;">
        <button onclick="kurangKavling()" id="btn-kurang"
            style="width:36px; height:36px; border-radius:9px; border:1.5px solid #e5e7eb;
        ...
        <span id="jumlah-kavling"
            style="min-width:48px; text-align:center; font-size:18px; font-weight:800;
                   color:#064e3b; background:#f0fdf4; border:1.5px solid #bbf7d0;
                   border-radius:9px; padding:4px 12px;">
            {{ $totalKavling ?? 108 }}
        </span>
        <button onclick="tambahKavling()" id="btn-tambah"
            style="width:36px; height:36px; border-radius:9px; border:1.5px solid #e5e7eb;
