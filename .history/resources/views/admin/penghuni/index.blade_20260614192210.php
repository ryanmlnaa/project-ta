    ...
    <div class="premium-card">
        ...
        <div class="premium-card-body kav-body">
            <div class="kavling-legend">
                ...
                <div class="legend-item">
                    <div class="legend-dot sudah"></div>
           ...
           <div class="kavling-grid">
                @for($i = 1; $i <= 108; $i++)
                    ...
                    @if(!$dataRumah)
                        {{-- Belum ada data sama sekali → bisa diklik --}}
                        <div class="kavling kosong" onclick="pilihKavling('{{ $i }}')">
                            {{ $i }}
                            <span class="kav-label">Kosong</span>
                        </div>

                    @elseif($dataRumah->status == 'Terisi')
                        {{-- Ada penghuni → tidak bisa diklik --}}
                        <div class="kavling terisi">
                            {{ $i }}
                            <span class="kav-label">Terisi</span>
                        </div>

                    @else
                        {{-- Ada data rumah tapi kosong → tidak bisa diklik --}}
                        <div class="kavling sudah-input">
                            {{ $i }}
                            <span class="kav-label">Diinput</span>
                        </div>
                    @endif
                @endfor
            </div>
...
function pilihKavling(no) {
    ...
    // Set selected option sesuai nomor kavling yang diklik
