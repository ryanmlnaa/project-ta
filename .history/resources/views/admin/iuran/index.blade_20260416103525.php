                            ...
                            @forelse($iuran as $i)
                                ...
                                : '-'
                                                    ...
                                                    <td>
                                                        ...
                                                        @if(auth()->user()->role == 'rt' && $l->status == 'diajukan')
                                                            <form action="{{ route('layanan.tanggapi.rt', $l->id) }}" method="POST">
                                                                @csrf
                                                                <textarea name="tanggapan_admin" class="form-control mb-2"></textarea>
                                                                <button class="btn btn-primary btn-sm">Tanggapi RT</button>
                                                            </form>
                                                        @endif

                                                        @if(auth()->user()->role == 'admin' && $l->status == 'proses')
<form action="{{ route('layanan.approve.admin', $l->id) }}" method="POST">
    @csrf
