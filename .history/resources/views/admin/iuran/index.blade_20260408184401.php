...
function loadData() {
    ...
    .then(data => {
        ...
        data.forEach((i, index) => {
            ...
            if(i.bukti_pembayaran && i.status == 'belum'){
                tombolApprove = `
                    <form action="/iuran/approve/${i.id}" method="POST" style="display:inline;">
            ...
            <tr>
                ...
                <td>
                    <a href="/iuran/edit/${i.id}" class="btn btn-warning btn-sm">Edit</a>

                    <form action="/iuran/delete/${i.id}" method="POST" style="display:inline;">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
