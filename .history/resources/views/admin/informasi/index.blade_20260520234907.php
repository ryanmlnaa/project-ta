...
<div class="container-fluid" style="padding: 20px 16px;">
    ...
    <div class="card">
        <div class="card-header">
           ...
           <a href="{{ route('admin.informasi.create') }}" class="btn btn-tambah">
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-wrap" style="display:flex; gap:6px; align-items:center; fl<a href="{{ route('admin.informasi.edit', $i->id) }}" class="btn btn-edit"> <a href="{{ route('informasi.edit', $i->id) }}" class="btn btn-edit">
