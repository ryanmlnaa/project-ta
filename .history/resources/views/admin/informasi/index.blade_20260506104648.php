...
<div class="container-fluid" style="padding: 24px 26px;">
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge-kategori">{{ $i->kategori }}</span></td>
                        <td>
                            @if($i->is_penting)
                        ...
                        <td><span class="views-text">{{ $i->views }}</span></td>
                        <td style="color:#6b7280; white-space:nowrap; font-size:13px;">
