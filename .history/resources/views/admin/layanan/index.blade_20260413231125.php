                        ...
                        <tbody>
                            @forelse($layanan as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary btn-tanggapi"
                                            data-id="{{ $item->id }}" data-toggle="modal" data-target="#modalTanggapi">
                                            Tanggapi
                                        </button>
...
document.addEventListener("click", function (e) {
    ...
    if (e.target.closest(".btn-tanggapi")) {

        let btn = e.target.closest(".btn-tanggapi");
        let id = btn.getAttribute("data-id");

        let form = document.getElementById("formTanggapi");

        form.action = "{{ url('admin/layanan/tanggapi') }}/" + id;

        console.log("SET ACTION:", form.action); // 🔥 debug
    }
...
<style>
    /* 🔥 MATIKAN HOVER SAAT MODAL AKTIF */
