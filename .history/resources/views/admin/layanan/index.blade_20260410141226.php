                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-primary"
                                    data-toggle="modal"
                                    data-target="#tanggapiModal{{ $item->id }}">
                                    <i class="fas fa-comment"></i> Tanggapi
                                </button>

                                <!-- Tombol Hapus -->
                                <form action="{{ route('layanan.delete', $item->id) }}"
                                      method="POST"
                        ...
                        <div class="modal fade" id="tanggapiModal{{ $item->id }}">
                            <div class="modal-dialog">
                                <form action="{{ route('layanan.tanggapi', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <textarea name="tanggapan_admin" class="form-control" required></textarea>
                                            </div>
