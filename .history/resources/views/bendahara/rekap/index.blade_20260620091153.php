    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('bendahara.rekap.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label>Periode</label>
                    <input type="text" class="form-control" value="{{ now()->translatedFormat('F Y') }}" readonly style="background:#f0f4f0;cursor:not-allowed;">
                    <input type="hidden" name="periode" value="{{ now()->translatedFormat('F Y') }}">
                </div>
