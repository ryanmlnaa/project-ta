...
<div class="iv-wrap">
  ...
  @endphp
  <div class="iv-stats fade-up d2" style="grid-template-columns:repeat(4,1fr);">
    ...
    <div class="iv-stat-card" style="border-top:3px solid #ef4444;">
      ...
      <div class="iv-stat-val" style="color:#b91c1c;">Rp {{ number_format($totalBelumBayar,0,',','.') }}</div>
        ...
        <table class="iv-table">
          ...
          <tbody id="iuranBody">
            ...
            <tr data-status="{{ $i->status == 'lunas' ? 'lunas' : ($i->bukti_pembayaran ? 'proses' : 'belum') }}">
              ...
              {{-- TAMBAH INI --}}
                <td style="font-size:13px;color:#4a5a4a;max-width:160px;">
                    {{ $i->keterangan ?? '-' }}
                </td>
              <td>
                @if($i->status == 'lunas')
  ...
  {{-- TABEL KAS TERPISAH --}}
  <div class="iv-table-card fade-up d4" style="margin-top:20px;">
    <div class="iv-table-head">
      <div class="iv-table-head-left">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align:right">
              ...
              @else
              <span style="font-size:12px;color:#9aaa9a;font-style:italic;">-</span>
              @endif
            </td>
          </tr>
          @empty
          <tr><td colspan="4" class="text-center" style="padding:30px;color:#9aaa9a;">Belum ada tagihan kas.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style="border-radius:18px;border:none;">
      <div class="modal-body" style="padding:24px;text-align:center;">
        ...
        <p style="color:#7a8a7a;font-size:13px;margin-bottom:20px;">Rp {{ number_format($k->jumlah,0,',','.') }}</p>

        <button onclick="bayarKasQris({{ $k->id }})" class="iv-btn-pay" style="width:100%;margin-bottom:10px;justify-content:center;">
