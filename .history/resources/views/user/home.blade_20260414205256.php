...
@section('content')
    <div class="container">
        ...
        <div class="mt-5">
            ...
            <h4 class="mb-3">📢 Informasi & Pengumuman</h4>
                ...
                @forelse($informasi as $info)
                    <div class="col-md-4 mb-4">
                        <a href="{{ route('user.informasi.detail', $info->id) }}" style="text-decoration:none; color:black;">
                            ...
                            <div class="card shadow-sm h-100 informasi-card">

                                {{-- 🔥 BADGE PENTING --}}
                                @if($info->is_penting)
                                    <span class="badge bg-danger posisi-badge">🔥 Penting</span>
                                @endif
