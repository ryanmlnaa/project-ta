        ...
        <div class="card-body">
            <form action="{{ route('user.simpan.penghuni') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="status_huni" class="form-control" required>
                ...
                <div class="form-group" id="tanggalKeluarField" style="display:none;">
...
<script>
    const statusHuni = document.querySelector('[name="status_huni"]');
    const tanggalKeluar = document.getElementById('tanggalKeluarField');

    statusHuni.addEventListener('change', function() {
        if (this.value === 'Kontrak') {
            tanggalKeluar.style.display = 'block';
        } else {
