            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <button
                        ...
                        data-harga="{{ $r->harga }}"
                          data-foto="{{ $r->foto ? asset('foto_rumah/'.$r->foto) : asset('no-image.png') }}"
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('user.ambil.rumah') }}">
                ...
                <div class="modal-body text-center">
                    ...
                    <img id="fotoRumah" class="img-fluid mb-3 rounded"
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('.kavling-btn').forEach(btn => {
        ...
        btn.addEventListener('click', function() {
            ...
            if (foto && foto !== 'null') {
                document.getElementById('fotoRumah').src = foto;
            } else {
                document.getElementById('fotoRumah').src = '/no-image.png';
            }
