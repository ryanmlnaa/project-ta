                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        @foreach($rumahList as $r)
                            <button type="button" class="btn m-1 kavling-btn
                                ...
                                data-id="{{ $r->id }}" data-blok="{{ $r->blok }}" data-nomor="{{ $r->no_rumah }}"
                                data-luas="{{ $r->luas_tanah }}" data-harga="{{ $r->harga }}"
                                data-foto="{{ asset('foto_rumah/' . $r->foto) }}" data-status="{{ $r->status }}">
                                {{ $r->no_rumah }}
                            </button>
                        @endforeach
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('user.ambil.rumah') }}">
                            ...
                            <div class="modal-body text-center">
                                ...
                                <img id="fotoRumah" class="img-fluid mb-3 rounded shadow"
                                    style="max-height:200px; object-fit:cover;">

                                <h5 class="fw-bold mb-3">Detail Rumah</h5>
