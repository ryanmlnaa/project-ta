...
@section('content')
    <div class="container">
        ...
        <div class="mt-5">
            ...
            <div id="carouselExample" class="carousel slide carousel-fade mb-4">

                <div class="carousel-inner rounded shadow">

                    @foreach($informasi->where('is_penting', 1)->values() as $key => $info)
            ...
            @foreach($informasi->where('is_penting', 1) as $info)
                <div class="modal fade" id="popupInfo" tabindex="-1">
            ...
            @forelse($informasi as $info)
                ...
                <a href="{{ route('user.informasi.detail', $info->id) }}" style="text-decoration:none; color:black;">

                    <div class="card mb-4 shadow-lg informasi-full">
                        ...
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col-md-4">
                                @if($info->gambar)
                                    <img src="{{ asset('informasi/' . $info->gambar) }}" class="img-fluid rounded-start h-100">
                                @else
                                    <img src="https://via.placeholder.com/400x250" class="img-fluid rounded-start">
                                @endif
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p>{{ Str::limit($info->isi, 100) }}</p>

                                    <span class="badge bg-primary">{{ $info->kategori }}</span>
...
@section('scripts')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            let el = document.querySelector('#carouselExample');

            if (!el) return;

            let carousel = new bootstrap.Carousel(el, {
                interval: 2000,  // auto slide
                ride: 'carousel',
                pause: false,    // 🔥 penting
                wrap: true       // loop
            });
