...
@section('content')
    ...
    <div class="gv-wrap">
        ...
        <header class="gv-hero">
            ...
            {{-- CLOCK WIDGET --}}
            <div class="gv-clock-widget">
                <div class="gv-clock-time" id="gv-clock-time">00:00:00</div>
                <div class="gv-clock-date" id="gv-clock-date">Memuat...</div>
            </div>
        </header>
                        ...
                        <div class="gv-pengaduan-footer">
                            ...
                            @if($p->status == 'selesai')
                                <form action="{{ route('user.layanan.delete', $p->id) }}" method="POST" class="d-inline">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="gv-btn-delete-sm" onclick="return confirm('Hapus pengaduan ini?')">
    ...
    <style>
        ...
        *::after {
        ...
        .gv-info-card:hover .gv-info-thumb img {
        ...
        .gv-info-card:hover .gv-info-cta {
            gap: 0.7rem;
        }
...
@media(max-width: 400px) {
    ...
    .gv-clock-time { font-size: 1.1rem; }
    .gv-clock-date { font-size: 0.58rem; }
}
    </style>
