...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* INFO BOX WA */
    .wa-info { display: none; background: rgba(255,255,255,0.12); border: 1px solid rgba(255,255,255,0.25); border-radius: 10px; padding: 10px 14px; margin-bottom: 16px; font-size: 12px; color: rgba(255,255,255,0.85); line-height: 1.5; }
    .wa-info.show { display: block; }
                ...
                <div class="method-group">
                    ...
                    <label>
                        ...
                        <div class="method-card">
                            ...
                            <span class="mc-sub">ke nomor terdaftar</span>
                        </div>
                    </label>

                </div>

                {{-- Info WA — muncul saat pilih WhatsApp --}}
                <div class="wa-info" id="waInfo">
                    💡 OTP akan dikirim ke nomor WhatsApp yang terdaftar di data penghuni Anda.
                </div>
...
<script>
    ...
    function toggleWaInfo() {
        if (optWa.checked) {
            waInfo.classList.add('show');
        } else {
            waInfo.classList.remove('show');
        }
    }

    optEmail.addEventListener('change', toggleWaInfo);
    optWa.addEventListener('change', toggleWaInfo);
    toggleWaInfo();
</script>
