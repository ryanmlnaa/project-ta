...
<div class="stat-card" style="--delay:0.05s">
    ...
    <div class="stat-body">
        ...
        <div class="prog-bar" style="margin-top:10px">
            <div class="prog-fill pf-green" style="width: {{ $rt1_rumah_total > 0 ? ($rt1_rumah_terisi / $rt1_rumah_total * 100) : 0 }}%"></div>
        </div>
    </div>
...
<div class="stat-card" style="--delay:0.1s">
    ...
    <div class="stat-body">
        ...
        <div class="prog-bar" style="margin-top:10px">
            <div class="prog-fill pf-sky" style="width: {{ $rt2_rumah_total > 0 ? ($rt2_rumah_terisi / $rt2_rumah_total * 100) : 0 }}%"></div>
        </div>
    </div>
...
<div class="stat-card" style="--delay:0.15s">
    ...
    <div class="stat-body">
        ...
        <div class="prog-bar" style="margin-top:10px">
            <div class="prog-fill" style="width: {{ $rt3_rumah_total > 0 ? ($rt3_rumah_terisi / $rt3_rumah_total * 100) : 0 }}%; background: linear-gradient(90deg,#be123c,#e11d48); height:100%; border-radius:100px;"></div>
        </div>
    </div>
...
.stat-icon-wrap.large { width: 60px; height: 60px; font-size: 1.45rem; margin-bottom: 0; }
