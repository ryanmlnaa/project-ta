...
@section('content')
    ...
    <div class="dash-wrap">
        ...
        <div style="margin-bottom:10px;margin-top:8px;">
            <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#94a3b8;margin-bottom:14px;display:flex;align-items:center;gap:8px;">
        ...
        <div class="stats-grid" style="margin-bottom:24px;grid-template-columns:repeat(3,1fr);">
            ...
            <div class="stat-card" style="--delay:0.4s">
                ...
                <div class="stat-body">
                    ...
                    <span class="stat-sub">Iuran terkonfirmasi bulan ini</span>
                </div>
                <div class="stat-glow g-green"></div>
            </div>
            ...
            <div class="stat-card" style="--delay:0.45s">
                ...
                <div class="stat-body">
                    ...
                    <h2 class="stat-val vc-teal" style="font-size:1.6rem;">
            ...
            <div class="stat-card wide" style="--delay:0.5s">
                <div class="stat-icon-wrap c-rose large">
                ...
                <div class="stat-body">
                    ...
                    <div class="prog-bar">
                        <div class="prog-fill" style="background:linear-gradient(90deg,#be123c,#e11d48);width:{{ $rekapBelumDikirim > 0 ? min($rekapBelumDikirim * 10, 100) : 0 }}%"></div>
                    </div>
                </div>
                <div class="stat-glow g-rose"></div>
            </div>

            <div class="stat-card wide" style="--delay:0.55s">
                <div class="stat-icon-wrap c-orange large">
                ...
                <div class="stat-body">
                    ...
                    <span class="stat-sub">Tagihan kas menunggu pembayaran penghuni</span>
                    <div class="prog-bar">
                        <div class="prog-fill pf-orange" style="width:{{ $tagihanKasBelumBayar > 0 ? min($tagihanKasBelumBayar * 10, 100) : 0 }}%"></div>
                    </div>
                </div>
                <div class="stat-glow g-orange"></div>
            </div>
        ...
        @else
        <div style="background:#fff;border-radius:18px;border:1px solid #e8ede9;padding:24px;margin-bottom:24px;text-align:center;color:#94a3b8;">
