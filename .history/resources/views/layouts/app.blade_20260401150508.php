                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarUser">
                          ...
                          <ul class="navbar-nav align-items-center">
                            ...
                            {{-- PROFILE --}}
                            <li class="nav-item">
                                <a href="{{ route('user.profil') }}" class="nav-link d-flex align-items-center gap-2 user-nav">
                            ...
                            <li class="nav-item">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="nav-link btn btn-link d-flex align-items-center logout-btn">
