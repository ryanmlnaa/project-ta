  ...
  public function storeUser(Request $request)
{
    ...
    if (Penghuni::where('user_id', auth()->id())->exists()) {
        return back()->with('error', 'Data penghuni sudah ada');
    }
    ...
    return redirect()->route('user.home')
        ->with('success', 'Data berhasil disimpan, silakan pilih rumah');
}
