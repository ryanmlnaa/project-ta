...
{
    // Input dari dropdown sudah bersih, tinggal uppercase saja
    $blok    = strtoupper(trim($request->blok));
    $noRumah = trim($request->no_rumah);

    // Cek duplikat langsung pakai query, sudah pasti format sama
    $sudahAda = \App\Models\Rumah::where('blok', $blok)
