...
class PenghuniController extends Controller
{
    ...
    public function editRumah($id)
    {
        public function editRumah($id)
{
    $rumah = Rumah::findOrFail($id); // 1 data

    return view('admin.penghuni.edit', [
        'penghuni' => new \App\Models\Penghuni(),
        'rumah' => $rumah,              // 🔥 ini 1 data
        'rumahList' => Rumah::all()     // 🔥 ini untuk select
    ]);
}

    // bikin dummy penghuni biar view tidak error
    $penghuni = new \App\Models\Penghuni();

    // ambil semua rumah untuk dropdown
    $rumahList = Rumah::all();
