 ...
 public function approveAdmin($id)
{
    ...
    return back()->with('success', 'Disetujui Admin + Notif terkirim');
}
        ...
        private function kirimNotif($layanan)
    {
        ...
        $statusText = $layanan->status == 'selesai'
            ? '✅ SELESAI'
            : '⏳ DIPROSES';
        ...
        // 🔥 WHATSAPP
        // =====================
        if ($layanan->penghuni->telepon) {

            $no = preg_replace('/^0/', '62', $layanan->penghuni->telepon);

            $pesan = "🏡 *GREEN VIEW RESIDENCE*\n";
            $pesan .= "━━━━━━━━━━━━━━━━━━━━━━\n";
            $pesan .= "📢 *UPDATE PENGADUAN*\n";
            $pesan .= "━━━━━━━━━━━━━━━━━━━━━━\n\n";
            ...
            $pesan .= "💬 Tanggapan : {$layanan->tanggapan_admin}\n\n";
