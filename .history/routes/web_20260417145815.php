...
Route::post('/kirim-otp', [AuthController::class, 'kirimOtp'])->name('kirim.otp');

Route::get('/verifikasi-otp', [AuthController::class, 'formOtp'])->name('form.otp');
Route::post('/verifikasi-otp', [AuthController::class, 'verifikasiOtp'])->name('verifikasi.otp');

Route::get('/reset-password', [AuthController::class, 'formReset'])->name('form.reset');
