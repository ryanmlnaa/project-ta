...
Route::middleware(['auth'])->prefix('admin')->group(function () {
   ...
   // =======================
    ...
    Route::middleware(['auth', 'role:admin'])->group(function () {
        ...
        Route::get('/admin/informasi/edit/{id}', [InformasiController::class, 'edit'])->name('informasi.edit');
        Route::put('/admin/informasi/update/{id}', [InformasiController::class, 'update'])->name('informasi.update');
        Route::delete('/admin/informasi/delete/{id}', [InformasiController::class, 'destroy'])->name('informasi.delete');
