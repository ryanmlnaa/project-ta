...
//     ->name('rt.dashboard');
   ...
   // =======================
    ...
    // LAPORAN
        ...
        // approveAdmin layanan dihapus - konfirmasi selesai dilakukan RT
    ...
    Route::middleware(['auth', 'role:rt'])->group(function () {
        ...
        Route::post('/layanan/{id}/konfirmasi-selesai', [LayananController::class, 'konfirmasiSelesai'])->name('layanan.konfirmasi.selesai');
...
Route::middleware(['auth', 'status.akun', 'role:bendahara', 'force.password'])->prefix('bendahara')->name('bendahara.')->group(function () {
    ...
    Route::get('/kas/tagihan/create', [App\Http\Controllers\Bendahara\KasController::class, 'createTagihan'])->name('kas.tagihan.create');
    Route::post('/kas/tagihan', [App\Http\Controllers\Bendahara\KasController::class, 'storeTagihan'])->name('kas.tagihan.store');
    Route::patch('/kas/{id}/konfirmasi', [App\Http\Controllers\Bendahara\KasController::class, 'konfirmasi'])->name('kas.konfirmasi');

    Route::patch('/iuran/{id}/konfirmasi', [App\Http\Controllers\Bendahara\IuranController::class, 'konfirmasiLunas'])->name('iuran.konfirmasi');
});
