...
Route::middleware(['auth', 'role:user'])->prefix('user')->group(function () {
    ...
    Route::get('/user/iuran', [UserIuranController::class, 'index'])->name('user.iuran');
    Route::get('user/iuran/upload/{id}', [UserIuranController::class, 'upload'])->name('user.iuran.upload');
    Route::post('user/iuran/upload/{id}', [UserIuranController::class, 'storeUpload'])->name('user.iuran.storeUpload');
    Route::get('user/iuran/status', [UserIuranController::class, 'status'])->name('user.iuran.status');
});
