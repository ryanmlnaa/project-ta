...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::put('/rumah/{id}', [PenghuniController::class, 'updateRumah'])->name('rumah.update');
...
Route::middleware(['auth', 'role:user'])->prefix('user')->group(function () {
    ...
    RRoute::get('/pilih-rumah/{id}', [UserController::class, 'pilihRumah'])
...
Route::post('/ambil-rumah', [UserController::class, 'ambilRumah'])
    ...
    Route::put('/rumah/update/{id}', [UserController::class, 'updateRumah'])
    ->name('user.rumah.update');
    ...
    Route::post('/pengaduan/store', [UserController::class, 'storePengaduan'])->name('user.pengaduan.store');
